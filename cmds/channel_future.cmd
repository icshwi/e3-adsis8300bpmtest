...
dbLoadRecords("sis8300bpmN.template",   "P=$(ACQ_PREFIX),R=$(N)-,PORT=$(ACQ_PORT),ADDR=$(C),TIMEOUT=1,NAME=Channel $(N)")
...
#           Subtracts background from input signal. This is done on raw sample
#           value and will also normalize the ADC offset of half input range.
...
dbLoadRecords("sis8300Process.template",    "P=$(ACQ_PREFIX),R=$(N)-PR1-,PORT=CH$(C).PROC1,ADDR=0,TIMEOUT=1,NDARRAY_PORT=$(ACQ_PORT),NDARRAY_ADDR=$(C),ENABLED=1")
...
dbLoadRecords("sis8300ROI.template",        "P=$(ACQ_PREFIX),R=$(N)-RI2-, PORT=CH$(C).ROI2,ADDR=0,TIMEOUT=1,NDARRAY_PORT=CH$(C).PROC1,NDARRAY_ADDR=0,ENABLED=1")
...
dbLoadRecords("sis8300Process.template",    "P=$(ACQ_PREFIX),R=$(N)-PR2-,PORT=CH$(C).PROC2,ADDR=0,TIMEOUT=1,NDARRAY_PORT=CH$(C).ROI2,NDARRAY_ADDR=0,ENABLED=1")
...
dbLoadRecords("sis8300ROI.template",        "P=$(ACQ_PREFIX),R=$(N)-RI3-, PORT=CH$(C).ROI3,ADDR=0,TIMEOUT=1,NDARRAY_PORT=CH$(C).PROC1,NDARRAY_ADDR=0,ENABLED=1")
...
dbLoadRecords("sis8300Process.template",    "P=$(ACQ_PREFIX),R=$(N)-PR3-,PORT=CH$(C).PROC3,ADDR=0,TIMEOUT=1,NDARRAY_PORT=CH$(C).ROI3,NDARRAY_ADDR=0,ENABLED=1")
...
dbLoadRecords("sis8300Stats.template",       "P=$(ACQ_PREFIX),R=$(N)-ST3-,  PORT=CH$(C).STAT3,ADDR=0,TIMEOUT=1,HIST_SIZE=256,XSIZE=$(XSIZE),YSIZE=$(YSIZE),NCHANS=$(NCHANS),NDARRAY_PORT=CH$(C).ROI3,NDARRAY_ADDR=0,TS_PORT=CH$(C).STAT3.TS,ENABLED=1")
